...
const VisaDetails = () => {
  ...
  return (
    <div className="dark:bg-gray-900 dark:text-white pb-10">
      <h2 className="text-center pt-32 text-3xl mb-10 font-bol oswald">
        Visa Details
      </h2>
      <div className="card bg-base-100 max-w-3xl mx-auto shadow-xl mb-10 dark:bg-gray-900 dark:text-white">
